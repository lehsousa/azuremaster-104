export const QUESTION_BANK = {
  "modulo1": [
    ...
    },
    {
      ...
      "options": [
        ...
        "az create group RG1 eastus",
        "az rg new --name RG1",
        "az resource group create RG1"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "PowerShell e Bash (com possibilidade de alternância)",
        "Apenas PowerShell",
        "Apenas Bash",
        "CMD e PowerShell"
      ],
    ...
    },
    {
      ...
      "options": [
        "Todos os recursos dentro do RG e o próprio RG são excluídos permanentemente",
        "Apenas o RG é excluído; os recursos são movidos para um grupo padrão",
        "Os recursos são marcados para 'soft delete' por 30 dias",
        "O RG é arquivado e os recursos parados"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Aplicar Tags (ex: Department:Marketing) nos recursos",
        "Mover recursos para Resource Groups separados por departamento",
        "Criar Subscriptions separadas para cada departamento",
        "Renomear todos os recursos com prefixos"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        ...
        "1 Zona de Disponibilidade",
        "3 Regiões diferentes",
        "Availability Sets apenas"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "A é Scale Out (Horizontal); B é Scale Up (Vertical)",
        "A é Scale Up; B é Scale Out",
        "Ambas são Scale Out",
        "Ambas são Scale Up"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Infrastructure as Code (IaC) com ARM Templates ou Bicep",
        "Scripts imperativos em PowerShell",
        "Provisionamento manual via Portal com prints",
        "Planilhas de Excel com configurações"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Apenas 'Environment:Prod' e 'Owner:Finance' (Tags originais preservadas)",
        "Apenas 'Location:USA' (Herda do novo RG)",
        "Todas as tags (Originais + Novo RG)",
        "Nenhuma tag"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        ...
        "Azure Pricing Calculator",
        "Azure Monitor",
        "Cost Management (apenas visualização)"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "5 VMs, 1 VNet, 2 Storage Accounts (As mesmas da primeira execução)",
        "15 VMs, 3 VNets, 6 Storage Accounts (Duplicados a cada execução)",
        "O Deployment falhará na segunda execução pois os recursos já existem",
        "Apenas os recursos da última execução (os anteriores são deletados)"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Resource Visualizer (Visualizador de Recursos)",
        "Exportar Template",
        "Azure Monitor",
    ...
    },
    {
      ...
      "options": [
        "Nomes de Storage Accounts devem ser globalmente únicos; VMs apenas únicos dentro do Resource Group",
        "Ambos devem ser globalmente únicos",
        "Ambos devem ser únicos apenas dentro do Resource Group",
        "É um bug intermitente do Azure"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "O deployment será bloqueado (A política é herdada)",
        "O deployment terá sucesso (A política não é herdada)",
        "Será gerado apenas um aviso (Warning)",
        "A tag será adicionada automaticamente com valor nulo"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "O diretório $HOME é montado em um Azure File Share persistente; o restante é contêiner efêmero",
        "É um bug do Cloud Shell",
        "Os arquivos são deletados por uma política de limpeza automática",
        "O logout não foi realizado corretamente"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        ...
        "RBAC com permissão 'Reader' para todos",
        "Backup diário",
        "Tags com valor 'Critical'"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Não, um recurso deve pertencer a exatamente um Grupo de Recursos",
        "Sim, um recurso pode estar em múltiplos RGs",
        "Sim, mas apenas se estiverem na mesma região",
        "Sim, até o limite de 5 RGs"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Azure Blueprints",
        "ARM Templates isolados",
        "Scripts PowerShell manuais",
        "Clonagem de Assinatura via Portal"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Para persistir arquivos do diretório $HOME (scripts, configs) entre as sessões",
        "Para armazenar os logs de auditoria do Azure",
        "Para salvar o histórico de comandos apenas",
        "Para pagar pelo uso de computação do Cloud Shell"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Sintaxe simplificada, menos código para o mesmo resultado e melhor experiência de desenvolvimento",
        "Suporte a provedores de nuvem concorrentes (AWS, GCP)",
        "Não precisa ser compilado para JSON",
        "Executa mais rápido que ARM Templates"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Remover o Lock explicitamente e depois excluir o Grupo de Recursos",
        "Usar o parâmetro --force no comando de exclusão",
        "Apenas elevar seus privilégios no PIM",
        "O Grupo de Recursos nunca poderá ser excluído"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "É um limite 'soft' (quota) que pode ser aumentado mediante solicitação ao suporte",
        "É um limite rígido (hard limit) de 10 assinaturas por conta",
        "Depende do tipo de cartão de crédito",
        "Não existe limite, é erro do sistema"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "A: System-assigned; B: User-assigned",
        "A: User-assigned; B: System-assigned",
        "Ambos são System-assigned",
        "Ambos são User-assigned"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Uma instância dedicada e isolada do Microsoft Entra ID que representa uma organização",
        "O mesmo que uma Assinatura (Subscription)",
        "Um usuário com permissões globais",
        "Uma região física de datacenters"
      ],
      "correctAnswer": 0,
  ...
  "modulo2": [
    ...
    },
    {
      ...
      "options": [
        "Azure RBAC (Role-Based Access Control) com funções Built-in",
        "Shared Access Signatures (SAS)",
        "Azure AD Groups com permissão de Owner",
        "Tags de recurso"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Criar um Grupo no Microsoft Entra ID, adicionar os usuários ao grupo e atribuir a função RBAC ao grupo",
        "Atribuir a função individualmente para cada usuário (20 atribuições)",
        "Compartilhar uma única conta de serviço entre os desenvolvedores",
        "Criar uma Custom Role específica para cada desenvolvedor"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        ...
        "Azure AD Connect",
        "Password Hash Sync",
        "Multi-Factor Authentication (MFA) apenas"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Utilizar Management Groups (Grupos de Gerenciamento) e aplicar a política no nível raiz ou apropriado da hierarquia",
        "Aplicar a política manualmente em cada assinatura via script",
        "Usar Azure Blueprints em cada assinatura",
        "Criar um ticket de suporte para a Microsoft aplicar globalmente"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Sim, a VM será afetada (Herança). Profundidade máxima de 6 níveis.",
        "Não, políticas não herdam. Profundidade de 10 níveis.",
        "Sim, mas eu posso desabilitar a herança. Ilimitado.",
        "Não, apenas novas VMs. 3 níveis."
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "No recurso individual (VM-ERP-01)",
        "No Resource Group",
        "Na Subscription",
        "No Management Group"
      ],
    ...
    },
    {
      ...
      "options": [
        ...
        "Complexidade de senha de 20 caracteres",
        "Troca de senha a cada 30 dias",
        "Login restrito por IP"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Criar uma Custom Role (Função Personalizada)",
        "Dar a função Contributor e pedir para terem cuidado",
        "Dar a função Owner apenas nos bancos de dados (trabalhoso)",
        "Usar Azure Policy para bloquear acesso a outros recursos"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "5.000 funções personalizadas",
        "2.000 funções personalizadas",
        "Ilimitado",
        "50 funções personalizadas"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Acessar o PIM no portal e 'Ativar' sua função",
        "Solicitar ao suporte da Microsoft",
        "Pedir a senha do Owner permanente",
        "Usar o comando az login --scope owner"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Service Principal (Objeto de Entidade de Serviço)",
        "Managed Identity",
    ...
    },
    {
      ...
      "options": [
        "O Deployment será bloqueado imediatamente e retornará um erro de 'Request Disallowed By Policy'",
        "A VM será criada, mas marcada como 'Non-Compliant' no painel depois de 24h",
        "A VM será criada, mas desativada",
        "A política pedirá confirmação extra ao administrador"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "O servidor é criado com sucesso, mas será marcado como 'Non-Compliant' e o evento será logado",
        "A criação é bloqueada",
        "O servidor é criado e a criptografia é habilitada automaticamente",
        "O servidor é deletado automaticamente após 1 hora"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Initiative Definition (Initiative / Policy Set)",
        "Policy Group",
        "Management Group Bundle",
        "Azure Blueprint"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Atribuir a 'Built-in Initiative' do CIS Benchmark no nível do Management Group Raiz",
        "Criar um script PowerShell que roda diariamente e verifica cada assinatura",
        "Atribuir cada política manualmente em cada assinatura",
        "Usar o Azure Monitor para alertar sobre violações"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Embora não haja um limite 'hard' estrito documentado para falhar o save, iniciativas muito grandes podem impactar o tempo de avaliação. O ideal é agrupar logicamente.",
        "O limite é de 10 políticas por iniciativa",
        "O limite é de 50 políticas por iniciativa",
        "Iniciativas não têm limite físico algum"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Policy é uma regra individual; Initiative é um grupo de Policies",
        "Policy é para segurança; Initiative é para custo",
        "Policy é gratuita; Initiative é paga",
    ...
    },
    {
      ...
      "options": [
        ...
        "Azure AD Connect",
        "Trust de Floresta do Active Directory"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Como um usuário do tipo 'Guest' (UserType = Guest)",
        "Como um usuário 'Member' regular",
        "Como um Contato de Email",
        "Ele não aparece no diretório, fica invisível"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "B2B ocorre no seu tenant corporativo principal; B2C é um tenant separado dedicado aos clientes",
        "B2B é pago; B2C é gratuito",
        "B2B suporta apenas Microsoft Accounts; B2C suporta Google",
        "Não há diferença arquitetural"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Criar uma Access Review recorrente para todos os Guests, pedindo que eles mesmos (Self-review) ou seus patrocinadores confirmem a necessidade de acesso contínuo",
        "Pedir ao RH para enviar lista de demitidos mensalmente",
        "Configurar expiração de conta de 30 dias para todos",
        "Bloquear acesso de guests permanentemente"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "User Risk indica probabilidade da identidade estar comprometida (ex: vazamento); Sign-in Risk indica probabilidade da tentativa de login atual não ser o dono (ex: IP suspeito)",
        "São sinônimos",
        "User Risk é para admins; Sign-in Risk para usuários",
        "User Risk bloqueia; Sign-in Risk apenas monitora"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Entitlement Management com Access Packages",
        "Dynamic Groups",
        "Blueprints",
        "PIM"
      ],
    ...
    },
    {
      ...
      "options": [
        "Grupos de Segurança/M365, Enterprise Applications e Sites SharePoint Online",
        "VMs e Storage Accounts",
        "Assinaturas do Azure",
        "Apenas Grupos de Segurança"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Atribuir uma Azure Policy com efeito 'DeployIfNotExists' no Management Group raiz",
        "Enviar email para os donos das assinaturas",
        "Usar um script de automação que roda uma vez por mês",
        "Habilitar manualmente em cada assinatura"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "O recurso, suas configurações ou propriedades violam uma regra definida em uma política atribuída ao escopo",
        "O recurso está desligado",
        "O recurso está com erro de funcionamento",
    ...
    },
    {
      ...
      "options": [
        "Criar uma 'Remediation Task' (Tarefa de Remediação) para a política",
        "Deletar e recriar os recursos antigos",
        "Editar cada recurso manualmente",
        "Aguardar 24h para atualização automática"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        ...
        "Workplace Join (Registered)",
        "AD Domain Join tradicional"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Dynamic User Group (Grupo Dinâmico)",
        "Assigned Group (Atribuído)",
        "Office 365 Group",
        "Distribution List"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Permite o uso do Identity Protection para detectar credenciais vazadas ('Leaked Credentials')",
        "É o único método que suporta MFA",
        "Não requer internet",
        "Permite login com Smart Cards"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Federation com AD FS (Active Directory Federation Services)",
        "Password Hash Sync",
    ...
    },
    {
      ...
      "options": [
        "O navegador negocia um ticket Kerberos com o Azure AD usando a conta de computador do objeto 'AZUREADSSOACC' criada no AD Local",
        "O Azure instala um cookie mágico no navegador",
        "O firewall libera o acesso",
        "O usuário usa biometria"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Agrupar políticas em Iniciativas (Initiatives) e atribuir a Iniciativa, em vez de atribuir policies individuais",
        "Aumentar o tier da assinatura",
        "Não usar policies",
  ...
  "modulo3": [
    ...
    },
    {
      ...
      "options": [
        "A conexão falhará, pois Azure Files não suporta FTP nativamente",
        "O upload funcionará normalmente",
        "O Azure Files converterá automaticamente para SMB",
        "Será necessário uma VPN para funcionar"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "A aplicação pode ler os dados da secundária, mas não pode gravar",
        "A aplicação pode ler e gravar na secundária automaticamente",
        "A aplicação não pode acessar nada até o failover",
        "A aplicação pode gravar na secundária, mas leitura é lenta"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Legal Hold (persiste até remoção)",
        "Time-based Retention (99 anos)",
        "Archive Tier Lock",
        "Read-only RBAC"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "SIM, a criptografia é automática (SSE) para todas as contas",
        "NÃO, requer habilitação manual",
        "Apenas se o tier for Premium",
        "Apenas se configurado HTTPS"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Ilimitado (limitado apenas pela capacidade da Storage Account)",
    ...
    },
    {
      ...
      "options": [
        "Claim Check Pattern (Armazenar payload no Blob, enviar URL/Ref na Queue)",
        "Otimizar o JSON para 64 KB",
        "Aumentar o limite da Queue via Ticket de Suporte",
    ...
    },
    {
      ...
      "options": [
        "Os snapshots incrementais armazenarão apenas as mudanças (diferencial), economizando espaço",
        "Cada snapshot ocupará 1 TB independentemente das mudanças",
        "Snapshots incrementais custam mais caro por GB",
        "Não há diferença de custo armazenamento, apenas de tempo"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Quando a transferência via rede demoraria mais do que o envio físico dos discos (ex: > 7 dias)",
        "Sempre que os dados forem maiores que 1 GB",
        "Nunca, a transferência via rede é sempre preferível",
        "Apenas quando exigido por conformidade governamental"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Minimização da latência (leituras locais)",
    ...
    },
    {
      ...
      "options": [
        "O blob de destino NÃO é deletado",
        "O blob de destino é deletado automaticamente",
        "O blob vai para Soft Delete no destino",
    ...
    },
    {
      ...
      "options": [
        "Transações de leitura (origem), escrita (destino) e Egress de dados entre regiões",
        "Apenas o custo de transações, o tráfego é gratuito",
        "Apenas uma taxa fixa mensal pelo serviço",
        "Nenhum custo adicional além do armazenamento"
      ],
      "correctAnswer": 0,
    ...
    {
      "id": 141,
      "question": "Você tem um requisito de conformidade para garantir que arquivos de log armazenados no Blob Storage sejam movidos automaticamente para o tier 'Cool' após 30 dias e para o tier 'Archive' após 365 dias. Além disso, logs com mais de 7 anos devem ser deletados. Qual funcionalidade você deve configurar?",
      "options": [
      ...
      "correctAnswer": 0,
      "explanation": "Lifecycle Management Policies (Políticas de Gerenciamento do Ciclo de Vida) permitem definir regras baseadas em `if-then` para transição automática de tiers (Hot->Cool->Archive) e exclusão de blobs com base na idade ou última modificação, sem necessidade de script ou automação externa.",
      "module": "Armazenamento"
    },
    {
      "id": 142,
      "question": "Uma aplicação precisa acessar dados no Blob Storage usando o protocolo NFS (Network File System) 3.0 para compatibilidade com um sistema Linux legado. O que você deve habilitar na conta de armazenamento para suportar isso?",
      "options": [
        "Hierarchical Namespace (HNS) e acesso via VNet",
        "Apenas o endpoint público",
        "SMB Protocol",
        "Azure Files"
      ],
      "correctAnswer": 0,
      "explanation": "O suporte a NFS 3.0 no Blob Storage requer que o 'Hierarchical Namespace' (Data Lake Gen2) esteja habilitado e que o acesso seja feito exclusivamente através de uma rede segura (VNet), pois o protocolo NFS não suporta autenticação moderna como OAuth/Entra ID, dependendo de segurança de rede.",
      "module": "Armazenamento"
    },
    {
      "id": 143,
      "question": "Sua empresa armazena documentos sensíveis de clientes diferentes no mesmo container de Blob. Cada cliente exige que seus dados sejam criptografados com uma chave única e dedicada (Customer-Managed Key), diferente da chave dos outros clientes. Criar uma Storage Account para cada cliente é inviável. Qual recurso permite criptografia granular no nível do Blob/Container?",
      "options": [
        "Encryption Scopes",
        "Storage Service Encryption (SSE) padrão",
        "Infrastructure Encryption",
        "Azure Rights Management"
      ],
      "correctAnswer": 0,
      "explanation": "Encryption Scopes (Escopos de Criptografia) permitem gerenciar chaves de criptografia no nível granular (container ou blob individual) dentro da mesma Storage Account. Você pode associar um escopo a um cliente específico e usar a chave dele, sem precisar provisionar novas contas de armazenamento.",
      "module": "Armazenamento"
    },
    {
      "id": 144,
      "question": "Você habilitou o acesso SFTP (SSH File Transfer Protocol) para seu Blob Storage para receber arquivos de parceiros. No entanto, os parceiros relatam erro de conexão. Você verificou o firewall e a rede está correta. Qual é um pré-requisito funcional para ativar o SFTP no Blob Storage?",
      "options": [
        "Habilitar Hierarchical Namespace (Data Lake Gen2)",
        "Habilitar NFS v3",
        "Criar um servidor Linux intermediário",
        "Desabilitar HTTPS"
      ],
      "correctAnswer": 0,
      "explanation": "O suporte nativo a SFTP no Azure Blob Storage EXIGE que a conta tenha o 'Hierarchical Namespace' (HNS) ativado. O SFTP depende da estrutura de sistema de arquivos real (diretórios) fornecida pelo HNS para gerenciar permissões e navegação.",
      "module": "Armazenamento"
    },
    {
      "id": 145,
      "question": "Você deseja proteger seus dados contra exfiltração. Você está usando Private Endpoints para acessar sua Storage Account. No entanto, você quer garantir que, se um invasor comprometer uma VM na sua VNet, ele não consiga usar essa VM para enviar dados para a Storage Account PESSOAL dele (fora da organização). Qual recurso previne isso?",
      "options": [
      ...
      "correctAnswer": 1,
      "explanation": "Uma Service Endpoint Policy permite filtrar quais Contas de Armazenamento específicas podem ser acessadas através do Service Endpoint. Você pode criar uma política que permite apenas a conta da empresa e bloqueia 'All Accounts', prevenindo que dados sejam copiados para contas não autorizadas (exfiltração) via rota otimizada.",
      "module": "Armazenamento"
    },
    {
      "id": 146,
      "question": "Você precisa pesquisar blobs específicos baseados em metadados de negócio personalizados (ex: 'ProjectID=123') em um container com milhões de objetos. Listar e iterar por todos os blobs é muito lento. Qual recurso permite indexar e consultar blobs por tags multidimensionais nativamente?",
      "options": [
        "Blob Index Tags",
        "Azure Search",
        "Metadata tradicional",
        "Hierarchical Namespace"
      ],
      "correctAnswer": 0,
      "explanation": "Blob Index Tags fornecem um mecanismo de indexação gerenciado onde você aplica tags chave-valor (ProjectID=123) aos blobs e o Azure indexa esses atributos. Isso permite filtrar e descobrir dados instantaneamente com base nas tags, sem varrer o container inteiro.",
      "module": "Armazenamento"
    },
    {
      "id": 147,
      "question": "Você está configurando o Azure Front Door para servir conteúdo estático do seu Blob Storage globalmente. Você quer garantir que o Blob Storage aceite conexões APENAS do Front Door e não diretamente da internet pública. Qual é a melhor prática para restringir esse acesso de origem?",
      "options": [
        "Usar Private Link (Private Endpoint) entre Front Door e Storage",
        "Service Tags no NSG",
        "Configurar IP Allowlist com os IPs do Front Door",
        "Header de verificação"
      ],
      "correctAnswer": 0,
      "explanation": "A integração moderna e mais segura (Premium SKU) permite conectar o Azure Front Door ao Blob Storage (Origin) usando Azure Private Link. O tráfego flui da borda da Microsoft para sua conta de armazenamento via rede privada, permitindo fechar o acesso público do Storage totalmente.",
      "module": "Armazenamento"
    },
    {
      "id": 148,
      "question": "Em um ambiente Data Lake Storage Gen2, você precisa conceder permissão de leitura a um usuário específico para apenas um arquivo dentro de uma estrutura de diretórios profunda. Você não quer usar RBAC no nível do Container pois daria acesso a tudo. Qual mecanismo de controle de acesso deve ser usado?",
      "options": [
        "Access Control Lists (ACLs) POSIX",
        "Azure RBAC Role (Reader)",
        "SAS Token com política",
        "Shared Key"
      ],
      "correctAnswer": 0,
      "explanation": "Data Lake Gen2 combina RBAC (Controle de Acesso) e ACLs (Listas de Controle de Acesso) estilo POSIX. Para granularidade no nível de arquivo e diretório individual, as ACLs são a ferramenta correta. O RBAC no Azure Storage geralmente opera no nível da Conta ou Container, não sendo granular arquivo-a-arquivo sem condições complexas.",
      "module": "Armazenamento"
    },
    {
      "id": 149,
      "question": "Você deletou um container de Blob que tinha o Soft Delete desativado, mas o gerenciamento de versões (Versioning) estava ativado. Você consegue recuperar o container deletado?",
      "options": [
        "Não, o Versioning protege blobs individuais, não o container em si.",
        "Sim, o Versioning guarda uma cópia do container.",
        "Sim, via suporte da Microsoft.",
        "Não, precisa de Snapshot."
      ],
      "correctAnswer": 0,
      "explanation": "O Versioning aplica-se a blobs individuais. Se você deletar o CONTÊINER inteiro, todas as versões dentro dele são deletadas também. Para proteger contra exclusão de container, você deve habilitar o 'Container Soft Delete'. Sem isso, a exclusão é permanente.",
      "module": "Armazenamento"
    },
    {
      "id": 150,
      "question": "Sua conta de armazenamento 'Hot' tem alto custo de transação de escrita. Você tem um log que é gravado em pequenos pedaços milhares de vezes por segundo. Qual tier é mais econômico para operações de alta frequência de escrita (High Transaction)?",
      "options": [
      ...
      "correctAnswer": 0,
      "explanation": "Embora o custo de 'armazenamento' GB seja maior no Premium, o Block Blob Premium tem custo de transação muito menor e latência muito menor para workloads intensivos em escrita. Para cenários com altíssima contagem de transações, o Premium pode ser mais barato no TCO que o Standard Hot.",
      "module": "Armazenamento"
    }
  ],
  "modulo4": [
    {
      ...
      "options": [
        ...
        "Single VM com Premium SSD",
        "Region Paris com GRS"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Azure VM Scale Sets com Autoscaling",
        "Azure Load Balancer",
        "Availability Sets",
        "Mudar para VMs maiores (Scale Up)"
      ],
      "correctAnswer": 0,
    ...
    {
      "id": 161,
      "question": "Você tem um Web App no plano Standard que precisa acessar um banco de dados SQL hospedado em uma Máquina Virtual na mesma VNet. O banco de dados não tem IP público. Qual recurso de rede do App Service você deve configurar para permitir essa comunicação privada?",
      "options": [
        "VNet Integration",
        "Hybrid Connections",
        "Service Endpoints",
      ...
      "correctAnswer": 0,
      "explanation": "VNet Integration (Regional) permite que o Web App acesse recursos dentro de uma VNet (como VMs, SQL, Redis com Private Endpoints). É a solução padrão para comunicação 'saindo' do App Service para a VNet. Hybrid Connections é para redes remotas/on-prem.",
      "module": "Computação"
    },
    {
      "id": 162,
      "question": "Sua Azure Function no plano de Consumo (Consumption) está demorando 15 segundos para responder após um período de inatividade. Isso está afetando a experiência do usuário (Cold Start). Qual a solução mais econômica para resolver o Cold Start mantendo a escala serverless, sem mudar para um App Service Plan dedicado caro?",
      "options": [
        "Mudar para o plano Premium (Elastic Premium)",
        "Ativar 'Always On'",
        "Usar um Timer Trigger para 'acordar' a função",
        "Mudar para Dedicated Plan Basic"
      ],
      "correctAnswer": 0,
      "explanation": "O plano Premium (Elastic Premium) oferece 'pre-warmed instances' que eliminam o Cold Start, mantendo a capacidade de escala elástica rápida e modelo de cobrança híbrido. 'Always On' não está disponível no plano de Consumo padrão. Timer Trigger é uma gambiarra não confiável.",
      "module": "Computação"
    },
    {
      "id": 163,
      "question": "Você precisa implantar um cluster Kubernetes (AKS) que suporte nativamente a execução de contêineres Windows Server. Qual Plugin de Rede (Network Plugin) é obrigatório para suportar nós Windows no AKS?",
      "options": [
        "Azure CNI",
        "Kubenet",
        "Docker Bridge",
      ...
      "correctAnswer": 0,
      "explanation": "Historicamente e por recomendação padrão de produção, o Azure CNI é o plugin de rede que oferece suporte completo e melhor desempenho para contêineres Windows no AKS, colocando os pods na VNet. O suporte a Windows no Kubenet existe mas tem limitações de performance e NAT.",
      "module": "Computação"
    },
    {
      "id": 164,
      "question": "Você gerencia um aplicativo multi-camada em VMs. Para a camada de banco de dados, a latência de rede entre as VMs deve ser a menor possível (microssegundos). As VMs devem estar fisicamente localizadas no mesmo data center. Qual recurso agrupador você deve usar?",
      "options": [
      ...
      "correctAnswer": 0,
      "explanation": "Proximity Placement Groups (Grupos de Colocação por Proximidade) garantem que os recursos de computação estejam fisicamente fisicamente próximos uns dos outros (co-localizados) para minimizar a latência de rede. Availability Sets/Zones focam em espalhar para HA, o que pode aumentar latência.",
      "module": "Computação"
    },
    {
      "id": 165,
      "question": "Você perdeu a senha de administrador local de uma VM Windows e RDP não conecta. Você precisa resetar a senha imediatamente. Qual extensão de VM ou ferramenta no portal permite fazer isso sem reiniciar a VM?",
      "options": [
        "Recurso 'Reset Password' (VMAccess Extension)",
        "Serial Console",
        "Boot Diagnostics",
        "Redeploy"
      ],
      "correctAnswer": 0,
      "explanation": "A lâmina 'Reset Password' no portal do Azure utiliza a extensão VMAccess Agent para redefinir as credenciais do administrador local ou configurações RDP dentro do sistema operacional, sem necessidade de reboot.",
      "module": "Computação"
    },
    {
      "id": 166,
      "question": "Você tem um Web App crítico. Você quer garantir que SSL/TLS seja processado (offloaded) antes de chegar ao seu código para economizar CPU, e que o certificado seja renovado automaticamente de graça. Qual tipo de certificado você deve usar no App Service?",
      "options": [
        "App Service Managed Certificate",
        "Upload de PFX manual",
        "Key Vault Certificate",
        "Self-signed"
      ],
      "correctAnswer": 0,
      "explanation": "App Service Managed Certificates são gratuitos, totalmente gerenciados pela Microsoft (emissão e renovação automática) e cobrem domínios customizados (CNAME). Eles removem a carga operacional de gerenciamento de certificados SSL básicos.",
      "module": "Computação"
    },
    {
      "id": 167,
      "question": "Sua equipe de desenvolvimento precisa executar tarefas de processamento de lote (Batch) de longa duração que exigem poder de computação massivo (HPC) esporadicamente. Eles não querem gerenciar filas de trabalho ou agendamento de VMs manualmente. Qual serviço é especializado nisso?",
      "options": [
        "Azure Batch",
        "VM Scale Set",
        "AKS",
      ...
      "correctAnswer": 0,
      "explanation": "Azure Batch é um serviço de agendamento de jobs e gerenciamento de computação que permite executar cargas de trabalho de computação de alto desempenho (HPC) e lote paralelos em grande escala. Ele gerencia o pool de compute nodes, instala apps e agenda os jobs.",
      "module": "Computação"
    },
    {
      "id": 168,
      "question": "Você está usando Azure Compute Gallery (Shared Image Gallery) para distribuir uma imagem de VM personalizada globalmente. Você precisa garantir que, na região East US, a imagem seja replicada para 3 zonas de disponibilidade diferentes para resiliência no deployment (ZRS). Como configurar?",
      "options": [
        "Definir o Target Region como 'East US' e Replica Count, escolhendo o Storage Account Type como ZRS se disponível na região.",
        "Criar 3 galerias diferentes.",
        "Usar Availability Sets para a imagem.",
        "Não é possível, imagens são regionais."
      ],
      "correctAnswer": 0,
      "explanation": "Na Azure Compute Gallery, ao definir as regiões de destino para replicação da imagem, você pode especificar o tipo de armazenamento. Escolhendo ZRS (Zone Redundant Storage) para a réplica da imagem, ela estará disponível através das zonas para implantações zonais resilientes.",
      "module": "Computação"
    },
    {
      "id": 169,
      "question": "Um script de inicialização 'Cloud-init' falhou em uma VM Linux nova. Onde você deve procurar os logs de saída do cloud-init para depurar o erro?",
      "options": [
      ...
      "correctAnswer": 0,
      "explanation": "O arquivo `/var/log/cloud-init-output.log` captura a saída padrão (stdout) e erro (stderr) de todos os estágios do cloud-init. É o primeiro local a verificar falhas de script de provisionamento.",
      "module": "Computação"
    },
    {
      "id": 170,
      "question": "Você precisa conectar uma Azure Function a um banco de dados SQL on-premise que está protegido por firewall corporativo, sem abrir portas de entrada no firewall da empresa. A Function roda no plano App Service Standard. Qual solução de conectividade híbrida usar?",
      "options": [
        "Hybrid Connections",
        "VNet Integration com VPN S2S",
        "Azure Gateway",
        "Expor SQL na internet"
      ],
      "correctAnswer": 0,
      "explanation": "Hybrid Connections (Conexões Híbridas) do App Service usam um agente (Hybrid Connection Manager) instalado no on-premise que cria um túnel de SAÍDA para o Azure Relay na porta 443. Isso permite que o Web App acesse o SQL on-prem sem abrir portas de ENTRADA no firewall corporativo.",
      "module": "Computação"
    },
    {
      "id": 171,
      "question": "Você quer implantar uma aplicação web em contêiner usando Azure Container Apps. Você precisa que a aplicação escale até ZERO quando não houver requisições HTTP, para economizar custos. O KEDA é suportado? Qual é a diferença para o AKS?",
      "options": [
        "Sim, Container Apps suporta scale-to-zero e KEDA nativamente (Serverless Containers). AKS requer nó ligado sempre (mesmo que 1).",
        "Não, Container Apps exige 1 réplica min.",
        "KEDA só funciona no AKS.",
        "AKS é mais barato para scale zero."
      ],
      "correctAnswer": 0,
      "explanation": "Azure Container Apps é construído sobre Kubernetes e KEDA, oferecendo uma experiência serverless real, incluindo Scale-to-Zero nativo baseada em triggers HTTP ou eventos KEDA. No AKS padrão, você paga pelos nós (VMs) do cluster, então mesmo sem pods, o custo fixo existe.",
      "module": "Computação"
    },
    {
      "id": 172,
      "question": "Em um cluster AKS, você precisa isolar a comunicação de rede entre pods. Por padrão, todos os pods podem falar com todos. Você quer permitir que o 'Frontend' fale com o 'Backend', mas impedir que 'Frontend' fale com 'Database' diretamente. Qual recurso do Kubernetes você deve aplicar?",
      "options": [
        "Network Policies",
        "NSGs",
        "Pod Security Policy",
      ...
      "correctAnswer": 0,
      "explanation": "Network Policies (Políticas de Rede) no Kubernetes fornecem segmentação de tráfego (micro-segmentação) entre pods usando seletores de rótulo (labels). É o firewall interno do cluster. NSGs protegem a subnet (nós), não pods individuais na mesma rede overlay.",
      "module": "Computação"
    },
    {
      "id": 173,
      "question": "Você tem um Web App com 'Always On' desativado. Usuários reclamam que a primeira requisição da manhã leva 30 segundos. O que está acontecendo?",
      "options": [
        "O processo do IIS/App entrou em idleness e descarregou (Idle Timeout). 'Always On' evita isso mantendo pings constantes.",
        "É problema de DNS.",
        "O Azure desliga a VM à noite.",
        "Cold start de Function."
      ],
      "correctAnswer": 0,
      "explanation": "Em planos Basic/Standard+, se 'Always On' estiver desativado, o Web App é descarregado da memória após 20 minutos de inatividade para poupar recursos. A próxima requisição força um recarregamento (boot) da aplicação, causando lentidão. Always On deve estar ativado para produção.",
      "module": "Computação"
    },
    {
      "id": 174,
      "question": "Para fins de governança, você quer garantir que todas as VMs criadas na assinatura tenham automaticamente o Agente de Monitoramento instalado. Se o usuário criar a VM sem o agente, o Azure deve instalá-lo pós-deploy. Qual feature do Azure Policy faz isso?",
      "options": [
        "DeployIfNotExists",
        "Deny",
        "Audit",
      ...
      "correctAnswer": 0,
      "explanation": "O efeito `DeployIfNotExists` verifica se um recurso relacionado (extensão de VM) existe. Se não existir, ele dispara um deployment de template ARM para criar/instalar o recurso (agente) automaticamente. É usado para remediate e enforce de configurações.",
      "module": "Computação"
    },
    {
      "id": 175,
      "question": "Você está configurando uma Logic App para processar arquivos PDF que chegam por email. O processamento do PDF (OCR) é pesado e feito por uma ferramenta de terceiros via API. A Logic App deve esperar a resposta dessa API por até 24 horas. Qual padrão usar?",
      "options": [
        "Webhook Pattern / Async polling",
        "Aumentar timeout HTTP para 24h",
        "Usar Loop infinito",
        "Não é possível"
      ],
      "correctAnswer": 0,
      "explanation": "Ações HTTP síncronas em Logic Apps têm timeouts curtos (minutos). Para processos longos (Long Running Operations), usa-se o padrão Webhook ou Polling assíncrono (202 Accepted + Location header). O Logic App 'dorme' (espera callback) e pode aguardar dias ou semanas.",
      "module": "Computação"
    },
    {
      "id": 176,
      "question": "Qual a diferença fundamental entre Azure Functions 'Durable Functions' e Functions normais?",
      "options": [
        "Durable Functions permitem escrever fluxos de trabalho stateful (com estado) em código, orquestrando múltiplas funções.",
        "Durable Functions são mais rápidas.",
        "Durable Functions rodam em GPU.",
        "Functions normais não suportam C#."
      ],
      "correctAnswer": 0,
      "explanation": "Durable Functions é uma extensão que permite definir workflows complexos (Chaining, Fan-out/Fan-in) em código imperativo (C#, JS, Python). O framework gerencia automaticamente o estado, checkpoints e retries, permitindo orquestração complexa que seria difícil em functions stateless puras.",
      "module": "Computação"
    },
    {
      "id": 177,
      "question": "Você precisa disponibilizar uma aplicação legado Windows (Client-Server) para usuários remotos via streaming de aplicativo (apenas a janela do app, não o desktop todo). Qual solução do Azure Virtual Desktop (AVD) usar?",
      "options": [
        "RemoteApp",
        "Full Desktop",
        "Personal Desktop",
      ...
      "correctAnswer": 0,
      "explanation": "No AVD, você pode publicar 'RemoteApps'. Isso apresenta apenas a janela da aplicação para o usuário final, parecendo que roda localmente, em vez de mostrar a área de trabalho completa do Windows (Full Desktop).",
      "module": "Computação"
    },
    {
      "id": 178,
      "question": "Você está usando Spot VMs em um Scale Set. Você definiu a 'Eviction Policy' como 'Deallocate'. Quando o Azure reivindicar a VM, o que acontece com o disco de OS e os dados nele?",
      "options": [
        "A VM é parada e desalocada, mas o disco e dados persistem (pagando storage).",
        "O disco é deletado imediatamente.",
        "A VM é reiniciada.",
        "Os dados são migrados para outra VM."
      ],
      "correctAnswer": 0,
      "explanation": "Com a política 'Deallocate', a VM vai para o estado 'Stopped (Deallocated)'. Você para de pagar pela computação, mas os discos (OS/Data) permanecem no Storage e você continua pagando por eles. Você pode realocar a VM depois se houver capacidade.",
      "module": "Computação"
    },
    {
      "id": 179,
      "question": "Você precisa investigar uma tela azul (BSOD) em uma VM Windows que não inicializa. Qual recurso permite ver um screenshot da tela da VM no estado atual?",
      "options": [
        "Boot Diagnostics",
        "Serial Console",
        "Activity Log",
      ...
      "correctAnswer": 0,
      "explanation": "Boot Diagnostics captura periodicamente um screenshot da tela do console da VM e o log serial. Isso permite visualizar erros de boot, BSODs ou telas de menu de recuperação sem acesso RDP.",
      "module": "Computação"
    },
    {
      "id": 180,
      "question": "Você quer executar um script PowerShell em 50 VMs simultaneamente para instalar um patch de emergência. As VMs estão em várias VNETs e algumas não têm IP público. Qual a maneira mais eficiente?",
      "options": [
        "Run Command (via Portal/CLI) ou Azure Automation Runbook",
        "RDP em cada uma",
        "Group Policy",
        "Startup Script"
      ],
      "correctAnswer": 0,
      "explanation": "O recurso 'Run Command' usa o Agente da VM para executar scripts PowerShell/Shell remotamente. Funciona mesmo sem portas abertas (usa conexão de saída do agente para o Azure). Azure Automation também escala bem.",
      "module": "Computação"
    },
    {
      "id": 181,
      "question": "No AKS, para garantir que pods críticos do sistema (como ingress controller) nunca sejam expulsos quando o nó fica sem recursos (OOM), o que você deve configurar?",
      "options": [
        "PriorityClass (Priority e Preemption)",
        "Taint e Toleration",
        "Resource Requests altos",
        "Node Selector"
      ],
      "correctAnswer": 0,
      "explanation": "PriorityClass é um objeto do Kubernetes que define a importância de um Pod. Pods com prioridade maior (como System Critical) não são evictados em favor de pods de menor prioridade e podem até preempter (matar) pods menores para agendar-se se o cluster estiver cheio.",
      "module": "Computação"
    },
    {
      "id": 182,
      "question": "Você tem um Web App com Deployment Slots: 'Production' e 'Staging'. Você configurou 'Auto Swap' para Staging->Production. Onde ocorre o 'Warm up' (aquecimento) da aplicação antes da troca?",
      "options": [
        "No slot de Staging (origem)",
        "No slot de Production (destino)",
        "Não existe warm up",
        "No Load Balancer"
      ],
      "correctAnswer": 0,
      "explanation": "O processo de Swap primeiro faz o 'warm up' da aplicação no slot de origem (Staging) - enviando requisições locais para garantir que carregou. Só depois que o warm up termina com sucesso é que o Azure troca os endereços virtuais, enviando o tráfego de produção para o worker aquecido. Isso garante Zero Downtime.",
      "module": "Computação"
    },
    {
      "id": 183,
      "question": "Qual é o SLA de uma VM Single Instance (sem Availability Set/Zone) se ela usar discos HDD Standard?",
      "options": [
        "Não há SLA de disponibilidade (0%)",
        "95%",
        "99%",
        "99.5%"
      ],
      "correctAnswer": 0,
      "explanation": "Para VMs Single Instance, o Azure só oferece SLA (99.5% ou mais) se usar discos Premium SSD ou Standard SSD. Se usar HDD Standard, não há garantia financeira de SLA de conectividade para instância única (apenas para AV Sets/Zones). Referência: SLA for VMs.",
      "module": "Computação"
    },
    {
      "id": 184,
      "question": "Você precisa atualizar o sistema operacional das 1000 VMs do seu VM Scale Set. Você quer que a atualização seja feita em ondas (batches) de 20%, garantindo que a aplicação continue disponível. Qual política de upgrade usar?",
      "options": [
      ...
      "correctAnswer": 0,
      "explanation": "Rolling Upgrade Policy (Atualização em Ondas) permite definir que o Azure atualize os nós do Scale Set em lotes (ex: 20% de cada vez), verificando a saúde antes de passar para o próximo lote. Isso garante HA durante manutenções.",
      "module": "Computação"
    },
    {
      "id": 185,
      "question": "Sua Function App precisa acessar segredos no Key Vault. Qual é a maneira mais segura de autenticar a Function no Key Vault sem hardcoded credentials?",
      "options": [
        "Managed Identity (System Assigned)",
        "Service Principal no código",
        "Certificado PFX",
        "Access Key do Vault"
      ],
      "correctAnswer": 0,
      "explanation": "Habilitar a Managed Identity (Identidade Gerenciada) na Function App dá a ela uma identidade no Azure AD. Você concede permissão a essa identidade no Key Vault (Access Policy ou RBAC). O código usa `DefaultAzureCredential` para obter o token automaticamente sem segredos.",
      "module": "Computação"
    },
    {
      "id": 186,
      "question": "Você precisa montar um compartilhamento de arquivos (SMB) persistente em múltiplos contêineres ACI (Azure Container Instances) simultaneamente (Linux e Windows). Qual serviço de armazenamento é suportado nativamente para mount volume no ACI?",
      "options": [
        "Azure Files",
        "Blob Storage (Fuse)",
        "Azure Disk",
      ...
      "correctAnswer": 0,
      "explanation": "Azure Files é o único storage compartilhado totalmente suportado para montagem direta como volume em ACI (Windows e Linux). Permite persistência de estado e compartilhamento entre grupos de contêineres.",
      "module": "Computação"
    },
    {
      "id": 187,
      "question": "Para otimizar custos no AKS, você quer usar Spot VMs para pools de nós que rodam jobs de processamento de imagem (interrompíveis) e VMs regulares para a API (crítica). Como estruturar o cluster?",
      "options": [
        "Multiple Node Pools (User Node Pools)",
        "Criar 2 clusters separados",
        "Usar apenas Spot",
        "Usar tags"
      ],
      "correctAnswer": 0,
      "explanation": "O AKS suporta Multiple Node Pools (Múltiplos pools de nós). Você mantém o 'System Node Pool' com VMs regulares para estabilidade e cria um 'User Node Pool' adicional configurado com Spot VMs para os workloads baratos e interrompíveis.",
      "module": "Computação"
    },
    {
      "id": 188,
      "question": "Você tem um aplicativo legado que requer a instalação de um driver USB personalizado e acesso ao registro do Windows. O aplicativo deve ser acessível via browser. Web App e Container não suportam isso. Qual a solução PaaS mais próxima ou IaaS gerenciada?",
      "options": [
        "Azure Virtual Desktop (AVD) ou VM IaaS",
        "Azure App Service Environment",
        "Service Fabric",
        "Cloud Services"
      ],
      "correctAnswer": 0,
      "explanation": "App Service e Containers (PaaS) não permitem acesso de baixo nível ao kernel/drivers (sandbox). A solução é usar uma VM completa (IaaS) ou Azure Virtual Desktop (VDI) para entregar o app, mantendo controle total do SO.",
      "module": "Computação"
    },
    {
      "id": 189,
      "question": "Ao usar Azure Durable Functions, onde o estado da orquestração (histórico de execução) é armazenado fisicamente?",
      "options": [
        "Azure Storage Account (Table, Queue, Blob)",
        "Cosmos DB",
        "SQL Database",
        "Memória RAM da Function"
      ],
      "correctAnswer": 0,
      "explanation": "O backend padrão do Durable Task Framework usa uma Azure Storage Account. Ele usa Queues para agendamento, Tables para histórico/estado e Blobs para payloads grandes. É por isso que uma Storage Account é obrigatória ao criar a Function.",
      "module": "Computação"
    },
    {
      "id": 190,
      "question": "Você precisa restringir o acesso ao seu Web App para apenas um range de IPs (seu escritório). Onde configurar isso de forma mais simples sem adicionar recursos extras como Gateway?",
      "options": [
        "Networking -> Access Restrictions no App Service",
        "NSG na VNet do Web App",
        "Configuração do IIS (web.config)",
        "Firewall do Windows"
      ],
      "correctAnswer": 0,
      "explanation": "A lâmina 'Networking > Access Restrictions' no recurso App Service permite definir regras de Allow/Deny baseadas em IP ou Service Tags diretamente no serviço, funcionando como um firewall de borda simples e gratuito integrado ao PaaS.",
      "module": "Computação"
    },
    {
      "id": 191,
      "question": "Sua VM Linux não responde. Você quer ver as mensagens do kernel (dmesg) em tempo real enquanto tenta reiniciá-la através do portal, para ver onde trava. Qual ferramenta usar?",
      "options": [
        "Serial Console",
        "Boot Diagnostics Snapshot",
        "Azure Monitor",
        "SSH"
      ],
      "correctAnswer": 0,
      "explanation": "O Serial Console fornece um terminal interativo (TTY) conectado à porta serial da VM (COM1). Ele mostra o output do kernel em tempo real durante o boot e permite interagir (login) mesmo se a rede/SSH estiverem inoperantes.",
      "module": "Computação"
    },
    {
      "id": 192,
      "question": "Você está criando uma imagem de VM generalizada. Antes de capturar a imagem, qual comando deve ser rodado dentro do Windows para remover informações exclusivas (SID, Drivers)?",
      "options": [
        "Sysprep /generalize",
        "Waagent -deprovision",
      ...
      "correctAnswer": 0,
      "explanation": "Sysprep (System Preparation Tool) com a flag `/generalize` é obrigatório no Windows para remover identificadores únicos (SIDs, nome do computador) e preparar o sistema para ser clonado/imagado. Sem isso, as VMs criadas a partir da imagem falharão ou terão conflitos.",
      "module": "Computação"
    },
    {
      "id": 193,
      "question": "Você precisa processar uploads de usuários em um contêiner. O processamento leva 20 minutos. Você quer usar Azure Container Instances (ACI). Qual a 'Restart Policy' recomendada para um container que roda um job até o fim e depois deve parar sozinho?",
      "options": [
        "OnFailure ou Never",
        "Always",
        "UnlessStopped",
      ...
      "correctAnswer": 0,
      "explanation": "Para jobs de 'Run-once' (Batch), a Restart Policy deve ser `OnFailure` (reinicia só se der erro) ou `Never`. Se usar `Always` (padrão para serviços web), o ACI reiniciará o contêiner eternamente cada vez que ele terminar o trabalho com sucesso (exit code 0), gerando loop e custo.",
      "module": "Computação"
    },
    {
      "id": 194,
      "question": "Qual recurso do Azure Service Bus diferencia ele do Azure Queue Storage e é essencial para sistemas financeiros (ordem garantida FIFO estrita)?",
      "options": [
        "Message Sessions / FIFO",
        "Letters maiores que 64KB",
        "Logs",
        "Criptografia"
      ],
      "correctAnswer": 0,
      "explanation": "Embora Queue Storage suporte filas, ele não garante ordem FIFO estrita em escala. O Azure Service Bus oferece 'Message Sessions' que garantem First-In-First-Out (FIFO) ordenado para mensagens pertencentes à mesma sessão, essencial para transações financeiras ondem a ordem importa.",
      "module": "Computação"
    },
    {
      "id": 195,
      "question": "Você quer implantar código no Function App empacotado como um Container Docker Customizado. Qual plano de hospedagem é necessário para suportar 'Custom Containers' no Functions?",
      "options": [
        "Premium Plan ou Dedicated (App Service) Plan",
        "Consumption Plan",
        "Free Plan",
        "Qualquer um"
      ],
      "correctAnswer": 0,
      "explanation": "O suporte a Containers Linux Customizados para Azure Functions NÃO está disponível no plano de Consumo (padrão Windows/Code). Requer Premium Plan ou App Service Plan (Dedicated) para rodar a imagem Docker personalizada.",
      "module": "Computação"
    },
    {
      "id": 196,
      "question": "Você tem uma VM com IP Público Dinâmico. Você parou (Stop/Deallocated) a VM à noite. Ao ligar de manhã, o IP mudou. Como garantir que o IP Público permaneça o mesmo mesmo após desalocação?",
      "options": [
        "Alterar a alocação do IP Público para 'Static'",
        "Usar DNS Dinâmico",
        "Não desligar a VM",
        "Usar IP Privado"
      ],
      "correctAnswer": 0,
      "explanation": "IPs Públicos com método de alocação 'Static' são reservados para o recurso e não mudam, mesmo que a VM seja parada/desalocada. O método 'Dynamic' libera o IP quando a VM desaloca.",
      "module": "Computação"
    },
    {
      "id": 197,
      "question": "Você precisa de um balanceador de carga para distribuir tráfego TCP na porta 1433 (SQL) para um cluster de backend. O balanceador deve suportar alta disponibilidade e zonas. Você não precisa de inspeção SSL. Qual escolher?",
      "options": [
      ...
      "correctAnswer": 0,
      "explanation": "Para tráfego não-HTTP (como SQL porta 1433) ou puramente TCP/UDP de baixa latência, o Azure Load Balancer (Camada 4) é a escolha correta. Application Gateway e Front Door são Camada 7 (HTTP/S) e não entendem protocolo SQL nativamente.",
      "module": "Computação"
    },
    {
      "id": 198,
      "question": "No Serviço de Aplicativo (Web App), o que são 'Kudu' ou 'SCM'?",
      "options": [
        "O painel de ferramentas avançadas e console de diagnóstico do Web App",
        "O motor de renderização",
        "O sistema de backup",
        "O firewall"
      ],
      "correctAnswer": 0,
      "explanation": "Kudu é o motor por trás de recursos de git deployment no Azure Web Apps, mas também fornece um site SCM (`.scm.azurewebsites.net`) que oferece console CMD/PowerShell, explorador de arquivos, logs e ferramentas de diagnóstico para o ambiente do App Service.",
      "module": "Computação"
    },
    {
      "id": 199,
      "question": "Você quer usar autenticação (Easy Auth) no seu Web App para forçar login com Azure AD, mas quer permitir que requisições não autenticadas acessem a página inicial ('/home'). O resto deve ser bloqueado. Como configurar?",
      "options": [
        "Configurar 'Action to take when request is not authenticated' para 'Allow anonymous requests' e usar regras de autorização no arquivo de configuração do app (authorization.json ou web.config)",
        "Não é possível, Easy Auth é tudo ou nada.",
        "Criar 2 Web Apps.",
        "Bloquear no NSG."
      ],
      "correctAnswer": 0,
      "explanation": "Ao configurar Authentication/Authorization no App Service, você pode definir a ação padrão para anônimos como 'Allow (no action)'. Isso passa o tráfego para a aplicação, que então decide quem bloqueia ou não. Alternativamente, usa-se arquivos de rota/configuração URL-based para granularidade.",
      "module": "Computação"
    },
    {
      "id": 200,
      "question": "Qual a função do 'Drain Timeout' (Draining) em um Backend Pool do Load Balancer durante manutenção?",
      "options": [
        "Manter conexões existentes ativas por um tempo para terminarem o trabalho, enquanto para de enviar novas conexões para a instância não saudável/em manutenção.",
        "Deletar a VM imediatamente.",
        "Reiniciar a VM.",
        "Aumentar a velocidade da rede."
      ],
      "correctAnswer": 0,
      "explanation": "Connection Draining permite que uma instância seja removida do balanceamento (ex: para update) suavemente. O LB para de enviar novas requisições, mas aguarda (até o timeout definido) que as conexões TCP ativas se encerrem naturalmente, evitando queda abrupta para usuários ativos.",
      "module": "Computação"
    }
  ],
  "modulo5": [
    {
      ...
      "options": [
        "Existe um NSG associado à interface de rede (NIC) da VM bloqueando a porta 3389",
        "O Firewall do Windows está bloqueando a conexão",
        "As VMs estão desligadas",
        "O serviço RDP não está rodando"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Allow SSH (Port 22) Source IP 203.0.113.10/32",
        "Allow SSH Source Any",
        "Deny All Inbound except 203.0.113.10",
        "Allow Any Port Source 203.0.113.10/32"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Azure Firewall com Application Rules",
        "Network Security Group (NSG) com Service Tags",
    ...
    },
    {
      ...
      "options": [
        "Azure Firewall Application Rule (Action: Deny)",
        "NSG Outbound Rule (Deny)",
    ...
    },
    {
      ...
      "options": [
        "Suporta no máximo 10 túneis Site-to-Site",
        "Não suporta criptografia",
        "Não permite BGP",
        "Largura de banda limitada a 1 Gbps"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Aumentar o tamanho da subnet para no mínimo /26 (ex: 10.1.255.0/26)",
        "Renomear a subnet para 'BastionSubnet'",
        "Diminuir o tamanho da subnet para /29",
        "Habilitar Service Endpoints na subnet"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "User Defined Route (UDR) com Destination 0.0.0.0/0 e Next Hop Virtual Appliance (10.0.1.4)",
        "Network Security Group (NSG) com regra outbound allow",
        "VNet Peering com 'Use Remote Gateway'",
        "Virtual Network Gateway no Spoke"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Habilitar IP Forwarding nas NICs da VM no portal do Azure",
        "Configurar regras de NSG",
        "Criar um Public IP para a NVA",
    ...
    },
    {
      ...
      "options": [
        "Diretamente para o Storage via backbone da Microsoft (Service Endpoint tem prioridade)",
        "Pelo Firewall (UDR tem prioridade)",
        "O tráfego será bloqueado",
        "Depende da configuração do NSG"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Um Network Security Group (NSG) ou Firewall no SO da VM está bloqueando ICMP",
        "O peering precisa de um Gateway VPN",
        "Os endereços IP das VNets estão sobrepostos",
        "O peering demora 24h para propagar"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "No sistema operacional da VM (ex: sysctl no Linux)",
        "Na subnet da NVA",
        "No NSG da NVA",
        "No Azure Firewall Policy"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        ...
        "Associar IPs públicos a cada VM",
        "Azure Bastion"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Adicionar mais endereços IP Públicos ao NAT Gateway (até 16 IPs totais)",
        "Criar um segundo NAT Gateway na mesma subnet",
        "Aumentar o Timeout de Ociosidade TCP",
        "Mudar o SKU do NAT Gateway"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Criar um Virtual Network Link entre a Private DNS Zone e a VNet2",
        "Configurar VNet Peering entre VNet1 e VNet2",
        "Reiniciar as VMs na VNet2",
        "Configurar um DNS Forwarder"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Não há endpoint próximo à Ásia. Solução: Adicionar um endpoint na região Ásia.",
        "O Traffic Manager está mal configurado. Solução: Mudar para método Weighted.",
        "Cache de DNS. Solução: Reduzir o TTL.",
        "Latência de rede global. Solução: Usar ExpressRoute."
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Sim, automaticamente. As regras aplicam-se dinamicamente.",
        "Não, você deve atualizar o NSG manualmente.",
        "Apenas após reiniciar a VM.",
        "Apenas se o NSG estiver na NIC."
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Simplifica o gerenciamento, permitindo agrupar VMs por função sem reescrever regras ao mudar IPs.",
        "Melhora a performance de rede diminuindo a latência.",
        "Reduz o custo da fatura do Azure.",
        "Aumenta o nível de criptografia do tráfego."
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "1000 regras por NSG. Melhor prática: consolidar regras usando ASGs e Service Tags.",
        "100 regras. Melhor prática: criar múltiplos NSGs.",
        "500 regras. Melhor prática: usar Azure Firewall.",
        "Ilimitado."
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Permitido, pois a regra 150 tem prioridade mais alta (número menor) que a 200.",
        "Negado, pois Deny sempre vence Allow.",
        "Negado, pois a regra 200 é mais recente.",
        "Permitido, pois ambas as regras são avaliadas."
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Ele será bloqueado (Denied) pela regra padrão 'DenyAllInbound'.",
        "Ele será permitido (Allowed) porque não há regra de bloqueio explícito.",
        "Ele será colocado em quarentena.",
        "Ele será permitido se vier da internet."
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Não, NSGs só podem ser associados a Subnets ou Interfaces de Rede (NICs).",
        "Sim, o NSG será herdado por todas as subnets.",
        "Sim, mas apenas se a VNet estiver na região US East.",
        "Não, você precisa de um Firewall para isso."
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "O pacote é bloqueado (Denied).",
        "O pacote é permitido (Allowed).",
        "O pacote é permitido apenas se a origem for interna.",
        "Causa um erro de configuração."
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "O Connection Monitor testa TCP (porta 80), enquanto o Ping usa ICMP. Um NSG está bloqueando apenas a porta 80.",
        "O Connection Monitor está quebrado.",
        "O Ping tem prioridade de roteamento sobre o TCP.",
        "As VMs estão em regiões diferentes."
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Adicionar o FQDN do domínio à 'Threat Intelligence Allowlist' na política do Firewall.",
        "Mudar o modo para 'Alert only'.",
        "Criar uma regra de Aplicação com prioridade 100.",
        "Desabilitar o Threat Intelligence."
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Usar o Azure Network Watcher Packet Capture.",
        "Usar o Azure Monitor Metrics.",
        "Habilitar NSG Flow Logs.",
        "Usar o Connection Monitor."
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "O VNet Peering não é transitivo.",
        "As VNets estão em regiões diferentes.",
        "Falta um Gateway VPN na VNet-B.",
        "O NSG está bloqueando o tráfego."
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "O tráfego é cobrado com base nas taxas de transferência de dados Inter-Region (entrada e saída).",
        "O tráfego é gratuito.",
        "Apenas o tráfego de saída é cobrado.",
        "Existe uma taxa fixa mensal por peering."
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Configurar uma Exclusão (WAF Exclusion) aplicada especificamente à regra ou caminho.",
        "Mudar o WAF para o modo 'Detection'.",
        "Desativar o conjunto de regras CRS inteiro.",
        "Aumentar o limite de tamanho do request body."
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Criar Virtual Network Links em cada VNet apontando para a Private DNS Zone.",
        "Configurar peering entre todas as VNets.",
        "Usar um servidor DNS Customizado (Bind/Windows).",
        "Habilitar Auto-Registration em todas as VNets."
      ],
      "correctAnswer": 0,
    ...
    {
      "id": 241,
      "question": "Você está gerenciando uma rede virtual global com o Azure Virtual Network Manager (AVNM). Você quer criar uma topologia Hub-and-Spoke onde todas as VNETs de Spoke em diferentes assinaturas sejam conectadas automaticamente a um Hub central sem precisar configurar peerings manualmente um a um. Qual funcionalidade do AVNM usar?",
      "options": [
        "Connectivity Configurations (Mesh ou Hub-and-Spoke)",
        "Security Admin Rules",
        "Routing Configurations",
        "Scope Management"
      ],
      "correctAnswer": 0,
      "explanation": "O Azure Virtual Network Manager permite definir 'Connectivity Configurations'. Ao selecionar o modelo 'Hub-and-Spoke', o AVNM gerencia e cria automaticamente os peerings bidirecionais necessários entre os grupos de rede (Spokes) e o Hub definido, automatizando a topologia em escala.",
      "module": "Redes Virtuais"
    },
    {
      "id": 242,
      "question": "Você tem um requisito de segurança onde certas regras de NSG (como bloquear SSH pra internet) devem ser aplicadas OBRIGATORIAMENTE a todas as VNets da organização e não podem ser removidas ou sobrescritas pelos donos das assinaturas individuais. Qual recurso do AVNM permite isso?",
      "options": [
        "Security Admin Rules",
      ...
      "correctAnswer": 0,
      "explanation": "Security Admin Rules (Regras de Administrador de Segurança) no AVNM têm precedência sobre os NSGs locais. Elas são avaliadas ANTES dos NSGs. Se uma Admin Rule define 'Block SSH', o tráfego é bloqueado independente do que o dono da VNet configure no NSG local. É a 'regra de ouro' para governança de rede.",
      "module": "Redes Virtuais"
    },
    {
      "id": 243,
      "question": "Sua aplicação usa um Gateway Load Balancer para encadear (service chaining) o tráfego através de uma NVA de inspeção antes de atingir o backend. Qual tecnologia de tunelamento é usada pelo Gateway Load Balancer para manter o fluxo simétrico e transparente?",
      "options": [
        "VXLAN",
        "IPsec",
        "GRE",
      ...
      "correctAnswer": 0,
      "explanation": "Gateway Load Balancer usa tunelamento VXLAN para encapsular o pacote original e enviá-lo à NVA appliance. A NVA inspeciona, desencapsula e retorna (ou dropa). Isso preserva o IP de origem e destino originais (transparência) e facilita a inserção de middleboxes.",
      "module": "Redes Virtuais"
    },
    {
      "id": 244,
      "question": "Você precisa conectar sua infraestrutura on-premise à Azure VNet usando ExpressRoute. No entanto, para fins de auditoria, você precisa inspecionar todo o tráfego que entra via ExpressRoute usando um Azure Firewall no Hub. Qual funcionalidade simplifica o roteamento para forçar o tráfego do Gateway para o Firewall sem UDRs complexas em todos os lugares?",
      "options": [
        "Azure Route Server",
        "BGP Community Tags",
      ...
      "correctAnswer": 0,
      "explanation": "Azure Route Server permite trocar informações de roteamento BGP entre suas NVAs (ou Gateway de ExpressRoute/VPN, indiretamente via configuração de BGP peering no NVA) e a SDN do Azure. Ele simplifica a injeção de rotas dinâmicas na VNet, permitindo redirecionar tráfego de forma centralizada.",
      "module": "Redes Virtuais"
    },
    {
      "id": 245,
      "question": "Em uma arquitetura Hub-Spoke, você tem um Gateway VPN no Hub. Os Spokes estão emparelhados (peering) com o Hub. Para que as VMs nos Spokes consigam acessar a rede on-premise através do Gateway do Hub, quais configurações são obrigatórias no Peering?",
      "options": [
        "Hub: 'Allow Gateway Transit'; Spoke: 'Use Remote Gateway'",
        "Hub: 'Use Remote Gateway'; Spoke: 'Allow Gateway Transit'",
        "Ambos: 'Allow Forwarded Traffic'",
        "Nenhuma configuração, é automático"
      ],
      "correctAnswer": 0,
      "explanation": "No lado do Hub (que possui o Gateway), você deve habilitar 'Allow Gateway Transit' (Permitir Trânsito de Gateway). No lado do Spoke (que não tem gateway), você deve habilitar 'Use Remote Gateway' (Usar Gateway Remoto) e 'Use Remote Gateway' desabilita o seu próprio se tivesse. Isso fecha o circuito de roteamento.",
      "module": "Redes Virtuais"
    },
    {
      "id": 246,
      "question": "Você está configurando o Azure NAT Gateway. Você notou que ele não suporta tráfego de entrada (Inbound). Como você deve arquitetar uma solução que requer tanto entrada escalável (Inbound) quanto saída segura e massiva (Outbound) para o mesmo conjunto de VMs?",
      "options": [
        "Combinar Standard Load Balancer (para Inbound) e NAT Gateway (para Outbound) na mesma subnet",
        "Usar apenas Load Balancer com Outbound Rules",
        "Criar duas interfaces de rede por VM",
        "Usar Basic Load Balancer"
      ],
      "correctAnswer": 0,
      "explanation": "A prática recomendada é usar o Standard Load Balancer para gerenciar o tráfego de entrada (Inbound VIP) e associar um NAT Gateway à subnet para gerenciar todo o tráfego de saída (Outbound). O NAT Gateway tem precedência sobre as Outbound Rules do LB, oferecendo melhor escalabilidade de portas SNAT.",
      "module": "Redes Virtuais"
    },
    {
      "id": 247,
      "question": "Seu ExpressRoute Circuit tem uma largura de banda de 10 Gbps. No entanto, você nota que a performance para uma VM específica está limitada a ~1-2 Gbps, gargalo no Gateway de ExpressRoute. Que funcionalidade permite que o tráfego pule o Gateway e vá direto do circuito para a VM para atingir alta performance?",
      "options": [
        "ExpressRoute FastPath",
        "ExpressRoute Direct",
        "Global Reach",
      ...
      "correctAnswer": 0,
      "explanation": "ExpressRoute FastPath melhora a performance do caminho de dados enviando o tráfego diretamente da borda da rede da Microsoft (Microsoft Enterprise Edge - MSEE) para a VM na VNet, contornando o Gateway de VNet virtual. Isso remove o gargalo de throughput do Gateway virtual.",
      "module": "Redes Virtuais"
    },
    {
      "id": 248,
      "question": "Você quer usar IPs públicos da sua própria faixa CIDR (BYOIP - Bring Your Own IP) no Azure para manter a reputação dos seus IPs antigos. Após trazer o range para o Azure Create Custom IP Prefix, qual o próximo passo para torná-los roteáveis na internet?",
      "options": [
        "Comissionar (Commission) o prefixo",
        "Associar a uma VM",
        "Criar regra de Firewall",
        "Nada, é automático"
      ],
      "correctAnswer": 0,
      "explanation": "Após provisionar o prefixo IP customizado (que valida a propriedade), ele ainda não é anunciado para internet. Você deve executar explicitamente a ação de 'Comissionar' (Commission) o prefixo para que a Microsoft comece a anunciá-lo via BGP para a Internet pública.",
      "module": "Redes Virtuais"
    },
    {
      "id": 249,
      "question": "Você precisa resolver nomes DNS de hosts on-premise a partir do Azure, e nomes do Azure a partir do on-premise (Split-horizon). A solução deve ser totalmente gerenciada, sem manter VMs IaaS rodando servidores DNS (Bind/Windows). Qual serviço usar?",
      "options": [
        "Azure DNS Private Resolver",
        "Azure DNS Private Zone",
        "Azure Traffic Manager",
        "DNS Forwarding Rulesset em VM"
      ],
      "correctAnswer": 0,
      "explanation": "Azure DNS Private Resolver é o serviço PaaS (gerenciado) que fornece endpoints de entrada (Inbound) e saída (Outbound) para resolução DNS híbrida. Ele substitui a necessidade de manter VMs de encaminhamento DNS (Forwarders) para resolver nomes entre Azure e On-premise via VPN/ExpressRoute.",
      "module": "Redes Virtuais"
    },
    {
      "id": 250,
      "question": "Qual SKU de Endereço IP Público é obrigatório para ser usado com Availability Zones (Zonal ou Zone-redundant) e com o Standard Load Balancer?",
      "options": [
        "Standard SKU",
        "Basic SKU",
        "Premium SKU",
      ...
      "correctAnswer": 0,
      "explanation": "O SKU 'Standard' de IP Público é obrigatório para cenários de disponibilidade avançada (Zone Redundant, Zonal) e para integração com outros recursos Standard como Standard Load Balancer, NAT Gateway e Application Gateway v2. O SKU Basic não suporta Zonas e está em processo de depreciação.",
      "module": "Redes Virtuais"
    }
  ],
  "modulo6": [
    ...
    },
    {
      ...
      "options": [
        "Threshold (Limiar), Aggregation Type (Agregação), Period (Janela) e Frequency (Frequência)",
        "Apenas o Threshold (90%)",
        "Apenas o Action Group",
        "Severity Level e Description"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Log Query Alert (Alerta de Consulta de Log)",
        "Metric Alert",
        "Activity Log Alert",
    ...
    },
    {
      ...
      "options": [
        "Azure Activity Log (Log de Atividades)",
        "Azure Monitor Metrics",
    ...
    },
    {
      ...
      "options": [
        "Criar um único Action Group e associá-lo a todas as 10 regras de alerta.",
        "Criar 10 Action Groups diferentes, um para cada regra.",
        "Configurar as ações diretamente dentro de cada regra de alerta.",
        "Usar Logic Apps para enviar os emails."
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Email/SMS/Push, Automação (Runbooks, Logic Apps, Functions), ITSM e Webhooks.",
        "Apenas Email e SMS.",
        "Apenas uma ação por grupo.",
        "Apenas Webhooks."
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Availability Tests (Standard URL Ping)",
        "Metrics Explorer",
        "Smart Detection",
        "Live Metrics Stream"
      ],
    ...
    },
    {
      ...
      "options": [
        "Custom TrackAvailability Test (Azure Functions)",
        "Standard URL Ping Test",
    ...
    },
    {
      ...
      "options": [
        "Eles são replicados automaticamente para a região par (West US) e podem ser restaurados lá.",
        "Eles são perdidos permanentemente.",
        "Você deve iniciar uma cópia manual para outra região.",
        "Eles são movidos para o Archive Tier."
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Sim, criptografia em trânsito (HTTPS) e em repouso (SSE) são padrão.",
        "Não, apenas em repouso.",
        "Não, a criptografia deve ser configurada manualmente.",
        "Sim, mas exige ExpressRoute."
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Sim, o Soft Delete retém os dados por 14 dias após a exclusão.",
        "Não, a exclusão do Vault é irreversível instantaneamente.",
        "Sim, mas apenas se você abrir um ticket de suporte Sev A.",
        "Não, 5 dias excede o limite de recuperação de 24 horas."
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Não. Para RPO de minutos, você deve usar o Azure Site Recovery (ASR).",
        "Sim, se você configurar snapshots a cada hora.",
        "Sim, o backup do Azure é contínuo.",
        "Não, você precisa de backup em fita."
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "VM Insights (com Dependency Agent)",
    ...
    },
    {
      ...
      "options": [
        ...
        "Backup manual via AzCopy",
        "Agente MARS em uma VM temporária",
        "Azure File Sync Snapshot"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Azure Backup para SQL Server em Azure VMs",
        "Snapshots de disco da VM",
        "Scripts de backup SQL manuais",
        "Agente MARS"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Replicar apenas métricas essenciais e ativar logs completos apenas após o failover.",
        "Duplicar toda a coleta de logs e métricas permanentemente.",
        "Não monitorar a região secundária.",
        "Usar apenas alertas manuais."
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Diagnostic Settings do Vault (enviando para Storage Account)",
        "Activity Log (limitado a 90 dias)",
        "Backup Reports",
        "Alertas de Backup"
      ],
      "correctAnswer": 0,
    ...
    },
    {
      ...
      "options": [
        "Smart Groups (Grupos Inteligentes)",
        "Action Groups",
        "Suppression Rules",
    ...
    {
      "id": 291,
      "question": "Você está migrando servidores de monitoramento Prometheus para o Azure. Você quer continuar usando suas queries PromQL (Prometheus Query Language) existentes e grafana, mas não quer gerenciar a infraestrutura de armazenamento e servidores Prometheus. Qual serviço usar?",
      "options": [
        "Azure Monitor Managed Service for Prometheus",
        "Log Analytics com KQL",
        "Azure SQL Database",
        "Metrics Advisor"
      ],
      "correctAnswer": 0,
      "explanation": "Azure Monitor Managed Service for Prometheus fornece um ambiente totalmente gerenciado compatível com o ecossistema Prometheus. Ele permite coletar e armazenar métricas usando o padrão Prometheus e consultá-las com PromQL, integrando nativamente com Azure Managed Grafana.",
      "module": "Monitoramento e Backup"
    },
    {
      "id": 292,
      "question": "Você precisa arquivar logs de auditoria de segurança por 7 anos para conformidade. Manter esses dados no tier 'Analytics' (padrão) do Log Analytics é muito caro. Qual a solução mais custo-eficiente dentro do workspace?",
      "options": [
        "Configurar o 'Table' específica para usar o tier 'Data Archive' (Basic Logs/Archive)",
        "Exportar para Storage Account GRS",
        "Usar Event Hubs",
        "Imprimir os logs"
      ],
      "correctAnswer": 0,
      "explanation": "Log Analytics agora suporta tiers de dados na tabela: 'Analytics' (quente, caro, KQL full), 'Basic' (mais barato, KQL limitado) e 'Archive' (retenção de longo prazo, armazenamento muito barato, requer reidratação para consulta). Mover tabelas antigas para o tier Archive dentro do workspace é mais integrado que exportar para Storage.",
      "module": "Monitoramento e Backup"
    },
    {
      "id": 293,
      "question": "Uma aplicação crítica caiu. Você precisa saber EXATAMENTE qual mudança foi feita na configuração da infraestrutura (ex: alteração de regra de NSG, mudança de tamanho de VM) nos últimos 24 horas que possa ter causado isso. O Activity Log é muito verboso. Qual ferramenta foca nessa correlação?",
      "options": [
      ...
      "correctAnswer": 0,
      "explanation": "Azure Monitor Change Analysis detecta alterações nas propriedades de recursos da infraestrutura e configurações de aplicação web. Ele correlaciona essas mudanças com sinais de disponibilidade, ajudando a responder 'O que mudou?' no momento do incidente.",
      "module": "Monitoramento e Backup"
    },
    {
      "id": 294,
      "question": "No contexto do Azure Monitor Agent (AMA), como você define O QUE coletar (Event Logs, Performance Counters) e PARA ONDE enviar (Workspace A, Workspace B) de forma centralizada para 1000 VMs?",
      "options": [
        "Data Collection Rules (DCR)",
        "Workspace Config",
        "Local Agent Config",
        "Diagnostic Settings Individuais"
      ],
      "correctAnswer": 0,
      "explanation": "Data Collection Rules (DCR) desacoplam a definição de coleta do agente. Você cria uma regra DCR dizendo 'Colete CPU e Memória e envie para Workspace X'. Depois, associa essa regra a 1000 VMs. Se quiser mudar para coletar Disco também, edita apenas a DCR e todas as 1000 VMs atualizam automaticamente.",
      "module": "Monitoramento e Backup"
    },
    {
      "id": 295,
      "question": "Você precisa fazer backup de discos gerenciados do Azure (Managed Disks) várias vezes ao dia (a cada 4 horas) sem impactar o desempenho da VM e sem instalar agentes. O backup deve ser incremental. Qual solução usar?",
      "options": [
        "Azure Disk Backup (Snapshot-based)",
        "Azure Backup for VM (VMSnapshot)",
        "Copy Blob",
        "MABS"
      ],
      "correctAnswer": 0,
      "explanation": "Azure Disk Backup é uma solução dedicada para backups frequentes e sem agente de Discos Gerenciados. Ele usa Snapshots Incrementais nativos e é orquestrado pelo Backup Vault (diferente do Recovery Services Vault tradicional para VMs). Permite políticas de backup mais agressivas que o backup de VM full.",
      "module": "Monitoramento e Backup"
    },
    {
      "id": 296,
      "question": "Sua política de backup exige proteção contra exclusão maliciosa. Além do Soft Delete, você quer garantir que, se um invasor roubar credenciais de administrador, ele NÃO consiga desabilitar o Soft Delete nem reduzir a retenção dos backups existentes. Qual recurso ativar?",
      "options": [
        "Multi-User Authorization (MUA) com Resource Guard",
        "RBAC Owner",
        "PIM",
        "Lock CanNotDelete"
      ],
      "correctAnswer": 0,
      "explanation": "Multi-User Authorization (MUA) para Backup adiciona uma camada extra de proteção. Antes de realizar operações críticas (como deletar backups ou desabilitar soft delete), o backup vault verifica se o usuário tem permissão em um recurso separado 'Resource Guard'. Isso permite separar deveres: o admin de backup não tem permissão no Resource Guard, exigindo aprovação de um admin de segurança.",
      "module": "Monitoramento e Backup"
    },
    {
      "id": 297,
      "question": "Você está usando Application Insights. Você quer ver as transações ponta-a-ponta, desde o frontend (JS), passando pelo backend (C#) até o banco de dados (SQL). No entanto, o frontend e o backend estão em recursos diferentes e os logs não estão correlacionados. O que falta configurar?",
      "options": [
        "Distribuited Tracing (W3C TraceContext) / SDK Instrumentation Key correta",
        "VNet Peering",
        "Access Keys",
        "Dependency Agent"
      ],
      "correctAnswer": 0,
      "explanation": "Para correlação ponta-a-ponta (Distributed Tracing), os componentes devem injetar e propagar cabeçalhos de contexto de rastreamento (W3C TraceContext). Garantir que ambos usem os SDKs corretos e apontem para o mesmo recurso (ou usem cross-resource query) é essencial para unir os telemetrias.",
      "module": "Monitoramento e Backup"
    },
    {
      "id": 298,
      "question": "Você tem um cluster SAP HANA crítico rodando em Azure VMs (Linux). Você precisa de um backup consistente de aplicação (certificando que a DB está quiesced/consistent) com RPO de 15 minutos para logs. Qual solução é certificada para isso?",
      "options": [
        "Azure Backup for SAP HANA on Azure VMs",
        "Disk Snapshots",
        "File Backup",
        "Third party only"
      ],
      "correctAnswer": 0,
      "explanation": "O Azure Backup oferece uma carga de trabalho especializada 'SAP HANA on Azure VMs'. É um backup streaming de banco de dados nativo (usando APIs Backint do HANA) que suporta backups completos, diferenciais e de log (cada 15 min), sem a necessidade de scripts complexos de snapshot.",
      "module": "Monitoramento e Backup"
    },
    {
      "id": 299,
      "question": "Seu Site Recovery está replicando VMs entre regiões. Você precisa testar o plano de Failover para auditoria, mas NÃO pode causar downtime na produção e nem impactar a replicação contínua. O que você deve fazer?",
      "options": [
        "Executar um 'Test Failover' (Drill)",
        "Executar um 'Failover' real e depois failback",
        "Parar a replicação temporariamente",
        "Restaurar um backup"
      ],
      "correctAnswer": 0,
      "explanation": "A função de 'Test Failover' (Simulação/Drill) no ASR cria cópias das VMs na região de destino em uma VNet isolada (sandbox) sem afetar as VMs de produção e sem interromper a replicação de dados. É a maneira padrão de validar DR.",
      "module": "Monitoramento e Backup"
    },
    {
      "id": 300,
      "question": "Qual é a principal diferença técnica entre um 'Recovery Services Vault' e um 'Backup Vault' no Azure atualmente?",
      "options": [
        "Recovery Services Vault foca em cargas IaaS/Híbridas (VM, SQL, MARS, ASR). Backup Vault foca em novas cargas PaaS (Blob, Disk, PostgreSQL).",
        "São apenas nomes diferentes para a mesma coisa.",
        "RSV é legado e não deve ser usado.",
        "Backup Vault é mais caro."
      ],
      "correctAnswer": 0,
      "explanation": "A Microsoft está movendo para o modelo 'Backup Vault' para cargas de trabalho mais novas e nativas da nuvem (Azure Blobs, Azure Disks, OSS Databases). O 'Recovery Services Vault' continua sendo o padrão para VMs, SQL em VM, Azure Files e Site Recovery. É importante escolher o cofre certo para o workload.",
      "module": "Monitoramento e Backup"
    }
  ]
};
